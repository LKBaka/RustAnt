...
impl LgIrConverter {
    pub fn new(program: Program) -> Self {
        let ir_module = IRModule {
            ...
            constant_pool: Box::new(IRConstantPool {
                entries: vec![],
            }),
            global_data_section: Box::new(IRGlobalDataSection {
                data: vec![],
            }),
        ...
        m.insert(TypeId::of::<ExpressionStatement>(), convert_expression_statement);
        m.insert(TypeId::of::<IntegerLiteral>(), convert_integer_literal);
