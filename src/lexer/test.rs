...
fn test_lexer() {
    ...
    let expected_tokens = vec![
        ...
        Token::new(TokenType::Eq, "==".into(), file.into(), 1, 1),
        Token::new(TokenType::Integer, "2".into(), file.into(), 1, 1),
    ];
...
fn test_lexer_2() {
    ...
    let expected_tokens = vec![
        ...
        Token::new(TokenType::Ident, "a".into(), file.into(), 1, 1),
        Token::new(TokenType::LBrace, "{".into(), file.into(), 1, 1),
        Token::new(TokenType::RBrace, "}".into(), file.into(), 1, 1),
    ];
...
fn test_lexer_3() {
    ...
    let expected_tokens = vec![
        ...
        Token::new(TokenType::GetClassMember, "::".into(), file.into(), 1, 1),
        Token::new(TokenType::Ident, "run".into(), file.into(), 1, 1),
        Token::new(TokenType::LParen, "(".into(), file.into(), 1, 1),
        Token::new(TokenType::RParen, ")".into(), file.into(), 1, 1),
    ];
